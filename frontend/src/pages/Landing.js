      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 py-20 sm:py-24 lg:py-28 relative">
            <div className="text-center max-w-4xl mx-auto">
              <div className="sf-fade-up inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50/80 px-3 py-1.5 text-xs font-semibold text-blue-700">
                ...
                1 mission gratuite · aucune carte bancaire
              </div>
        ...
        <section className="py-20 sm:py-24 bg-blue-600 text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-5 sm:px-6 text-center relative">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 text-xs font-semibold"><Zap className="w-3.5 h-3.5" />1 mission gratuite</div>
            ...
            <p className="mt-5 text-blue-100 text-lg max-w-2xl mx-auto">Créez votre compte, ajoutez jusqu'à 10 intervenants et testez ShiftFlow sur une vraie mission. Aucune carte bancaire demandée.</p>
