          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <div>
                ...
                <em>Partager le contact</em>.
                Vous pouvez aussi copier plusieurs
                contacts depuis Google Contacts /
                iCloud et les coller ici. Format :{" "}
...
function WhatsAppImportModal({
  ...
  const [contactsReady, setContactsReady] =
    useState(false);

  const [loadingSeconds, setLoadingSeconds] =
    useState(0);

  // ----------------------------------------------------------
  // RESET COMPLET DE L'ÉTAT WHATSAPP
  // ----------------------------------------------------------
  ...
  const loadStatus = async () => {
    try {
      ...
      // Si WhatsApp est connecté mais que les contacts
      // sont encore en cours de synchronisation.
      if (
        data.contactsLoading ||
        !data.contactsLoaded
      ) {
        setContactsReady(false);
      }
      ...
      try {
        ...
        // ----------------------------------------------------
        // IMPORTANT :
        // Si le backend renvoie une liste vide alors que
        // WhatsApp vient juste de se reconnecter, on attend
        // encore.
        // ----------------------------------------------------
        ...
        // ----------------------------------------------------
        // WHATSAPP A PU ÊTRE DÉCONNECTÉ ENTRE /status
        // ET /contacts.
        // ----------------------------------------------------
        ...
        // Une autre erreur ne doit pas faire disparaître
        // complètement l'interface.
        console.log(
          "⚠️ Impossible de récupérer les contacts pour le moment."
        );
      }

    } catch (err) {
      // Erreur réseau / backend indisponible.
      // On ne détruit pas immédiatement l'état si on avait
      // une session valide : le prochain polling réessaiera.

      console.log(
        "⚠️ Statut WhatsApp temporairement indisponible."
      );
    }
  };
  ...
  useEffect(() => {
    ...
    // Cela permet de détecter rapidement une déconnexion
    // manuelle depuis WhatsApp > Appareils connectés.
  ...
  const importContacts = async () => {
    ...
    try {
      ...
      // ------------------------------------------------------
      // Cela évite de lancer /whatsapp/import avec une
      // ancienne liste si la déconnexion vient juste d'avoir
      // lieu.
      // ------------------------------------------------------
      ...
      if (!currentStatus.connected) {
        ...
        toast.error(
          "WhatsApp vient d'être déconnecté. Reconnectez-le pour importer des contacts."
        );
      ...
      // ------------------------------------------------------
      // WHATSAPP S'EST DÉCONNECTÉ JUSTE AVANT / PENDANT IMPORT
      // ------------------------------------------------------
      ...
      if (statusCode === 400) {
        ...
        toast.error(
          "WhatsApp a été déconnecté. Reconnectez votre compte pour continuer."
        );
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Sélectionnez les contacts à ajouter à vos
              intervenants.
            </p>
          </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-5 text-center">
              ...
              {status?.hasQR && status?.qr ? (
                ...
                <>
                  ...
                  <p className="text-xs text-gray-400 mt-4">
                    Si vous venez de vous déconnecter, le nouveau
                    QR code va apparaître automatiquement.
                  </p>
                </>
              )}
          ...
          !contactsReady && (
            <div className="mt-6">
              <div className="bg-gray-50 border border-gray-200 rounded-xl p-10 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">
                  Synchronisation de vos contacts WhatsApp en
                  cours.
                </p>
  ...
  return (
    <div data-testid="workers-page">
      ...
      >
        ...
        <div>
          <strong>Astuce :</strong> pour ajouter 20+
          intervenants d'un coup, utilisez{" "}
          <strong>Import rapide</strong> et collez
          directement une liste depuis WhatsApp,
          Google Contacts ou un tableur.
        </div>
