  ...
  return (
    <div data-testid="dashboard-page">
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <Link to="/app/missions/new" data-testid="new-mission-btn" className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-xl sm:rounded-md font-semibold sm:font-medium transition-colors shadow-sm">
          <Plus className="w-4 h-4"/> Nouvelle mission
        </Link>
      </div>

      <div className={`mt-5 rounded-xl border p-4 flex items-start sm:items-center gap-3 ${connected ? "bg-green-50 border-green-200" : "bg-amber-50 border-amber-200"}`} data-testid="whatsapp-status-banner">
