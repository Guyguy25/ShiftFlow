...
async function startSession(state) {
    ...
    try {
        ...
        sock.ev.on("connection.update", async update => {
            ...
            if (connection === "open") { state.connected = true; state.qr = null; state.qrText = null; state.initialSyncDone = true; state.lastConnectionError = null; console.log(`✅ WHATSAPP CONNECTÉ [${state.id}]`); }
            if (connection === "close") {
